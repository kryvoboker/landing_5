 ...
 */
function(e){"use strict";function t(e){return new RegExp("(^|\\s+)"+e+"(\\s+|$)")}var n,i,o;function s(e,t){(n(e,t)?o:i)(e,t)}"classList"in document.documentElement?(n=function(e,t){return e.classList.contains(t)},i=function(e,t){e.classList.add(t)},o=function(e,t){e.classList.remove(t)}):(n=function(e,n){return t(n).test(e.className)},i=function(e,t){n(e,t)||(e.className=e.className+" "+t)},o=function(e,n){e.className=e.className.replace(t(n)," ")});var r={hasClass:n,addClass:i,removeClass:o,toggleClass:s,has:n,add:i,remove:o,toggle:s};"function"==typeof define&&define.amd?define(r):e.classie=r}(window),function(){var e=document.body,t=document.querySelector(".content-wrap"),n=document.getElementById("open-button"),i=document.getElementById("close-button"),o=!1;function s(){const t=document.querySelector(".header__burger");o?(classie.remove(e,"show-menu"),classie.remove(t,"active-opacity")):(classie.add(e,"show-menu"),classie.add(t,"active-opacity")),o=!o}n.addEventListener("click",s),i&&i.addEventListener("click",s),t.addEventListener("click",(function(e){var t=e.target;o&&t!==n&&s()}))}(),$((function(){$(".header__slider").slick({dots:!0,infinite:!0,speed:500,slidesToShow:1,autoplay:!0,nextArrow:'<button type="button" class="slick-btn slick-next"></button>',prevArrow:'<button type="button" class="slick-btn slick-prev"></button>'}),AOS.init()})),document.querySelector("#search-icon").onclick=function(){this.classList.add("active");document.querySelector(".header__icons").classList.add("active"),document.querySelector(".header__search-button").classList.add("active"),document.querySelector(".header__search-input").classList.add("active")},document.querySelector("#disable-fon").onclick=function(){const e=document.querySelectorAll(".active");if(e.length>0)for(let t=0;t<e.length;t++){const n=e[t];n.classList.contains("active")&&n.classList.remove("active")}},document.querySelector("#disable-content").onclick=function(){const e=document.querySelectorAll(".active");if(e.length>0)for(let t=0;t<e.length;t++){const n=e[t];n.classList.contains("active")&&n.classList.remove("active")}},filterSelection("all");for(var btnContainer=document.getElementById("myBtnContainer"),btns=btnContainer.getElementsByClassName("btn"),i=0;i<btns.length;i++)btns[i].addEventListener("click",(function(){var e=document.getElementsByClassName("active");e[0].className=e[0].className.replace(" active",""),this.className+=" active"}));$((function(){document.querySelector("#loadMore").onclick=function(){const e=document.querySelectorAll(".projects__item--display--none");if(0!=e.length)for(let t=0;t<e.length;t++){const n=e[t];t<6&&n.classList.remove("projects__item--display--none")}$("#loadMore").blur()}})),window.addEventListener("DOMContentLoaded",(function(){var e=document.querySelectorAll(".video"),t=document.querySelector(".presentation__inner");e.forEach((function(e){e.addEventListener("click",(function(){if(!e.classList.contains("ready")){t.classList.add("ready"),e.classList.add("ready");var n=e.dataset.src;e.insertAdjacentHTML("afterbegin",'<iframe src="'+n+'" title="YouTube video player" frameborder="0"allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"allowfullscreen></iframe>')}}))}))})),$((function(){$(".posts__slider").slick({dots:!1,infinite:!1,speed:500,slidesToShow:3,autoplay:!1,nextArrow:'<button type="button" class="slick-btn slick-next"></button>',prevArrow:'<button type="button" class="slick-btn slick-prev"></button>',responsive:[{breakpoint:700,settings:{slidesToShow:2,slidesToScroll:2}},{breakpoint:500,settings:{slidesToShow:1,slidesToScroll:1}}]})}));